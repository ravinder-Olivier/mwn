...
window.addEventListener("load", function () {
  if (document.getElementById('insertMail')) {
    ...
    let domain = "macwilliamsworstnightmares.com" ; // Update yours informations here
...
// Locations
$(function () {
    $(".card").on('click', () => {window.location.href = "https://www.youtube.com/@macwilliams-worst-nightmares"});
})
// Location socials
$(function () {
    $('.facebook').on('click', function(event) {
      event.preventDefault();
      window.location.href = "https://www.youtube.com/@macwilliams-worst-nightmares";
    });
